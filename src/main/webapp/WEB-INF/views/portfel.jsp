...
<body onload="odliczanie();">
   ...
   <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Portfel</h1>
                    
                <div class="panel panel-primary">
                  <div class="panel panel-heading"><h3> Środki:</h3></div>
                    <div class="panel body">
                         <table>
                         <tr>
                            <td>
                              <div class="panel panel-success">
                                <div class="panel panel-heading"><h5> Saldo:</h5></div>
                                     <div class="panel body">
              ...
              <td>
             <div class="panel panel-success">
                                <div class="panel panel-heading"><h5> Wprowadz numer karty aby doładować środki:</h5></div>
                                     <div class="panel body">
                                      
                                         <form:form commandName= "user" action = "doladuje" method="POST" role="form" >
                                         <div class="form-group">
                                         <input class="form-control" name="number"  type="number"  min="10000000" max="100000000" required/>
                                           </div>
                                     
                                <div class="form-group error" >      ${error_active} </div>
                                      
                                        
                                         <button class="btn btn-primary btn-outline btn-primary"> Dodaj środki </button>
