...
<body onload="odliczanie();">
   ...
   <div id="wrapper">
        ...
        <div id="page-wrapper">
           ...
           <div>  ${shoplink} </div>
           <div>Pobieranie linku z sesji ${sessionScope.shop.link_send_data} </div>
             <table>
             <tr>
             <td>
             
          
            <form action="http://192.168.1.103:8083/SpringMVC/transactionstatus" method=POST>
            <input hidden name="transaction_id" value= ${sessionScope.transaction_id}>
             <button> Wróć do sklepu aby dokończyć transakcję </button>
            </form>
             <!--a href= "http://192.168.1.103:8083/SpringMVC/transactionstatus"  class="btn btn-primary"> Wróć do sklepu aby dokończyć transakcję </a -->
