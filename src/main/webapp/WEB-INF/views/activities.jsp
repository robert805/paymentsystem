...
<body onload="odliczanie();">
   ...
   <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Historia Konta</h1>
  ...
  <div class="panel-body">
                    ...
                    <form:form  action= "activitiessearch" role="form"  method="POST">
                         
                          <table style="text-align: center">
                  <tr> 
                  <td><div class="panel panel-success">
                  <div class="panel panel-heading"> Data do:</div>
                    <div class="panel body">
                  
                 
                              <div class="form-group">
                                    <input class="form-control" type="text" id="datepicker" placeholder="data od" name="after"  path="after" required>
                            ...
                            <td> <div class="panel panel-success">
                  <div class="panel panel-heading"> Data od:</div>
                    <div class="panel body">
                              ...
                              <div class="form-group">
                                   <input class="form-control" type="text" id="datepicker1" placeholder="data do" name="before" path="before">
                                </div>
                                </div>
                                </div>  
                          </td>
                           ...
                           <div class="form-group">
                             ...
                             <td>   <button class="btn btn-primary btn-outline btn-block"> Szukaj </button>
                             </div>
                             </form:form>
                             </td>
                            
                             <form:form  action= "activitiespastweek" role="form"  method="POST">
                             
                              </td>
                           <div class="form-group">
                                <!-- Change this to a button or input when using this as a form -->
                             <td>   <button class="btn btn-primary btn-outline btn-block"> Ostatni tydzien </button>
                             </div>
                              ...
                              <form:form  action= "activitiespastmonth" role="form"  method="POST">
                             <div class="form-group">
                                <!-- Change this to a button or input when using this as a form -->
                             <td>   <button class="btn btn-primary btn-outline btn-block"> Ostatni miesiac </button>
                             </div>
                             </td>
                             </form:form>
                              ...
                              <div class="form-group">
                                <!-- Change this to a button or input when using this as a form -->
                             <td>   <a href="activities" class="btn btn-primary btn-outline btn-block"> Wszystkie wyniki </button>
                             </div>
                             </td>
                                </tr>
                          </table> 
  ...
  <table class="table">
    <thead>
      <tr>
        ...
        <th>Rodzaj aktywnosci</th>
        <th>Data i czas</th>
        <th>Adres ip urządzenia</th>
      </tr>
    </thead>
    <tbody>
  ...
  <div class="panel-body">
  <div style="text-align: center">   ${listValue.activity_type}</div>
  </div>
 </div></td>  
  
  <td><div class="panel panel-primary">
  <div class="panel-body">
 <div style="text-align: center">  ${listValue.date } </div>
  </div>  </td>
  
   <td><div class="panel panel-primary">
  <div class="panel-body">
 <div style="text-align: center">  ${listValue.ip} </div>
  </div>  </td>
      </tr>
